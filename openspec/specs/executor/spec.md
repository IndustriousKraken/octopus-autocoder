...
- **WHEN** the MCP child starts with `ORCH_MCP_ROLE = architecture_advisor`
...
- **WHEN** a `drift_audit`, `architecture_advisor`, OR `documentation_audit` run is built
