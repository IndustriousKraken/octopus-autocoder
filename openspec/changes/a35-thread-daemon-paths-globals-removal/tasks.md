...
- [x] 3.7 `autocoder/src/audits/mod.rs` — function-parameter pattern (variation accepted by spec). `AuditLogWriter::open` accepts `paths: &DaemonPaths`.
- [x] 3.8 `autocoder/src/audits/scheduler.rs` — function-parameter pattern (variation accepted by spec). Helpers thread `paths: &DaemonPaths`.
