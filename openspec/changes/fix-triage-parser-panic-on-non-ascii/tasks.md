...
- [ ] 1.1 In `autocoder/src/lanes/ingestion.rs::strip_label`, replace the
  ...
  `prefix.len()`.
- [ ] 1.2 Keep the subsequent `line[prefix.len()..]` slice and the
...
- [ ] 2.1 Add a unit test `strip_label_does_not_panic_on_multibyte_boundary`
