...
- [x] 1.1 `dispatch_returns_error_on_unparseable_json` (in
...
- [x] 2.1 `dispatch_returns_error_when_action_field_missing` — spin
...
- [x] 2.2 Same test — also send `{"unrelated":"x"}` and verify it
