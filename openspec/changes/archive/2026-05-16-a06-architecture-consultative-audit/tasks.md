...
- [x] 2.4 If the drift-audit landed first with a shared LLM-audit helper, reuse it here. Otherwise consider extracting after both land.
...
- [x] 3.1 In `cli/run.rs::build_audit_registry`, append `Arc::new(ArchitectureConsultativeAudit::new(&audit_settings, &cfg.executor))`.
